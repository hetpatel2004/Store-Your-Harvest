...
const seedStorageData = (owner1Id, owner2Id, owner3Id) => [
  {
    ...
    humidityMin: 85,
    humidityMax: 95,
    acceptedCrops: ['Potato', 'Tomato', 'Onion', 'Chilli', 'Carrot', 'Mango', 'Apple', 'Banana', 'Grapes', 'Maize', 'Wheat', 'Soybean', 'Pulses'],
    minimumQuantity: 200,
    pricePerKg: 2.20,
    handlingCharge: 350,
  ...
  },
  {
    ...
    humidityMin: 90,
    humidityMax: 98,
    acceptedCrops: ['Tomato', 'Potato', 'Apple', 'Grapes', 'Carrot', 'Mango', 'Banana', 'Chilli', 'Maize', 'Wheat', 'Soybean', 'Pulses'],
    minimumQuantity: 100,
    pricePerKg: 2.50,
    handlingCharge: 400,
  ...
  },
  {
    ...
    humidityMin: 70,
    humidityMax: 90,
    acceptedCrops: ['Onion', 'Potato', 'Mango', 'Banana', 'Tomato', 'Apple', 'Grapes', 'Chilli', 'Carrot', 'Maize', 'Wheat', 'Soybean', 'Pulses'],
    minimumQuantity: 50,
    pricePerKg: 1.95,
    handlingCharge: 300,
  ...
  },
  {
    ...
    humidityMin: 85,
    humidityMax: 95,
    acceptedCrops: ['Carrot', 'Potato', 'Apple', 'Grapes', 'Chilli', 'Mango', 'Banana', 'Tomato', 'Onion', 'Maize', 'Wheat', 'Soybean', 'Pulses'],
    minimumQuantity: 150,
    pricePerKg: 2.30,
    handlingCharge: 380,
  ...
  },
  {
    ...
    humidityMin: 80,
    humidityMax: 95,
    acceptedCrops: ['Tomato', 'Mango', 'Banana', 'Potato', 'Onion', 'Chilli', 'Carrot', 'Apple', 'Grapes', 'Maize', 'Wheat', 'Soybean', 'Pulses'],
    minimumQuantity: 100,
    pricePerKg: 2.40,
    handlingCharge: 360,
    transportRatePerKm: 25,
  ...
  },
  {
    ...
    humidityMin: 85,
    humidityMax: 95,
    acceptedCrops: ['Banana', 'Mango', 'Tomato', 'Potato', 'Chilli', 'Carrot', 'Apple', 'Grapes', 'Onion', 'Maize', 'Wheat', 'Soybean', 'Pulses'],
    minimumQuantity: 100,
    pricePerKg: 2.10,
    handlingCharge: 320,
  ...
  },
  {
    ...
    humidityMin: 80,
    humidityMax: 90,
    acceptedCrops: ['Tomato', 'Potato', 'Onion', 'Chilli', 'Carrot', 'Apple', 'Grapes', 'Mango', 'Banana', 'Maize', 'Wheat', 'Soybean', 'Pulses'],
    minimumQuantity: 50,
    pricePerKg: 1.85,
    handlingCharge: 280,
  ...
  },
  {
    ...
    humidityMin: 85,
    humidityMax: 95,
    acceptedCrops: ['Tomato', 'Potato', 'Carrot', 'Grapes', 'Mango', 'Banana', 'Apple', 'Chilli', 'Onion', 'Maize', 'Wheat', 'Soybean', 'Pulses'],
    minimumQuantity: 100,
    pricePerKg: 2.15,
    handlingCharge: 340,
    transportRatePerKm: 24,
  ...
  // NEW: Organic Herb & Spice Cold Storage
  {
    ...
    humidityMin: 75,
    humidityMax: 85,
    acceptedCrops: ['Chilli', 'Grapes', 'Tomato', 'Mango', 'Banana', 'Apple', 'Carrot', 'Potato', 'Onion', 'Maize', 'Wheat', 'Soybean', 'Pulses'],
    minimumQuantity: 50,
    pricePerKg: 3.20,
    handlingCharge: 450,
  ...
  // NEW: Dairy & Perishable Cold Chain
  {
    ...
    humidityMin: 80,
    humidityMax: 90,
    acceptedCrops: ['Banana', 'Mango', 'Tomato', 'Potato', 'Carrot', 'Apple', 'Grapes', 'Chilli', 'Onion', 'Maize', 'Wheat', 'Soybean', 'Pulses'],
    minimumQuantity: 200,
    pricePerKg: 2.80,
    handlingCharge: 400,
