...
const seedStorageData = (owner1Id, owner2Id, owner3Id) => [
  {
    ...
    humidityMin: 85,
    humidityMax: 95,
    acceptedCrops: ['Potato', 'Tomato', 'Onion', 'Chilli', 'Carrot', 'Mango', 'Apple', 'Banana', 'Grapes', 'Maize', 'Wheat', 'Soybean', 'Pulses', 'Brinjal', 'Cauliflower', 'Cabbage', 'Okra', 'Pumpkin'],
    minimumQuantity: 200,
    pricePerKg: 2.20,
    handlingCharge: 350,
  ...
  },
  {
    ...
    humidityMin: 90,
    humidityMax: 98,
    acceptedCrops: ['Tomato', 'Potato', 'Apple', 'Grapes', 'Carrot', 'Mango', 'Banana', 'Chilli', 'Maize', 'Wheat', 'Soybean', 'Pulses', 'Brinjal', 'Cauliflower', 'Cabbage', 'Okra', 'Pumpkin'],
    minimumQuantity: 100,
    pricePerKg: 2.50,
    handlingCharge: 400,
  ...
  },
  {
    ...
    humidityMin: 70,
    humidityMax: 90,
    acceptedCrops: ['Onion', 'Potato', 'Mango', 'Banana', 'Tomato', 'Apple', 'Grapes', 'Chilli', 'Carrot', 'Maize', 'Wheat', 'Soybean', 'Pulses', 'Brinjal', 'Cauliflower', 'Cabbage', 'Okra', 'Pumpkin'],
    minimumQuantity: 50,
    pricePerKg: 1.95,
    handlingCharge: 300,
  ...
  },
  {
    ...
    humidityMin: 85,
    humidityMax: 95,
    acceptedCrops: ['Carrot', 'Potato', 'Apple', 'Grapes', 'Chilli', 'Mango', 'Banana', 'Tomato', 'Onion', 'Maize', 'Wheat', 'Soybean', 'Pulses', 'Brinjal', 'Cauliflower', 'Cabbage', 'Okra', 'Pumpkin'],
    minimumQuantity: 150,
    pricePerKg: 2.30,
    handlingCharge: 380,
  ...
  },
  {
    ...
    humidityMin: 80,
    humidityMax: 95,
    acceptedCrops: ['Tomato', 'Mango', 'Banana', 'Potato', 'Onion', 'Chilli', 'Carrot', 'Apple', 'Grapes', 'Maize', 'Wheat', 'Soybean', 'Pulses', 'Brinjal', 'Cauliflower', 'Cabbage', 'Okra', 'Pumpkin'],
    minimumQuantity: 100,
    pricePerKg: 2.40,
    handlingCharge: 360,
    transportRatePerKm: 25,
  ...
  },
  {
    ...
    humidityMin: 85,
    humidityMax: 95,
    acceptedCrops: ['Banana', 'Mango', 'Tomato', 'Potato', 'Chilli', 'Carrot', 'Apple', 'Grapes', 'Onion', 'Maize', 'Wheat', 'Soybean', 'Pulses', 'Brinjal', 'Cauliflower', 'Cabbage', 'Okra', 'Pumpkin'],
    minimumQuantity: 100,
    pricePerKg: 2.10,
    handlingCharge: 320,
  ...
  },
  {
    ...
    humidityMin: 80,
    humidityMax: 90,
    acceptedCrops: ['Tomato', 'Potato', 'Onion', 'Chilli', 'Carrot', 'Apple', 'Grapes', 'Mango', 'Banana', 'Maize', 'Wheat', 'Soybean', 'Pulses', 'Brinjal', 'Cauliflower', 'Cabbage', 'Okra', 'Pumpkin'],
    minimumQuantity: 50,
    pricePerKg: 1.85,
    handlingCharge: 280,
  ...
  },
  {
    ...
    humidityMin: 85,
    humidityMax: 95,
    acceptedCrops: ['Tomato', 'Potato', 'Carrot', 'Grapes', 'Mango', 'Banana', 'Apple', 'Chilli', 'Onion', 'Maize', 'Wheat', 'Soybean', 'Pulses', 'Brinjal', 'Cauliflower', 'Cabbage', 'Okra', 'Pumpkin'],
    minimumQuantity: 100,
    pricePerKg: 2.15,
    handlingCharge: 340,
    transportRatePerKm: 24,
  ...
  // NEW: Organic Herb & Spice Cold Storage
  {
    ownerId: owner1Id,
    name: 'Organic Herb & Spice Cold Storage',
    tagline: 'Precision-controlled storage for medicinal herbs and premium spices',
    address: 'Survey 12, Sanod Road, Vatva, Ahmedabad',
    city: 'Ahmedabad',
    district: 'Ahmedabad',
    state: 'Gujarat',
    latitude: 23.0412,
    ...
    availableCapacity: 650000,
    temperatureMin: 8,
    temperatureMax: 15,
    humidityMin: 75,
    humidityMax: 85,
    acceptedCrops: ['Chilli', 'Grapes', 'Tomato', 'Mango', 'Banana', 'Apple', 'Carrot', 'Potato', 'Onion', 'Maize', 'Wheat', 'Soybean', 'Pulses', 'Brinjal', 'Cauliflower', 'Cabbage', 'Okra', 'Pumpkin'],
    minimumQuantity: 50,
    pricePerKg: 3.20,
    handlingCharge: 450,
    transportRatePerKm: 30,
    storageDuration: '7 to 60 days',
    paymentTerms: 'Premium rates for organic certification compliance. UPI preferred.',
    damagePolicy: 'Specialized humidity control prevents mold in herbs. 80% coverage against quality degradation.',
    powerBackup: true,
    cctvMonitoring: true,
    rating: 4.6,
    reviewsCount: 12,
    ...
    contactEmail: 'herbs@organiccold.in',
    features: ['Humidity-preserving chambers', 'Sterile environment', 'Hermetic sealing'],
  },
  // NEW: Dairy & Perishable Cold Chain
  {
    ownerId: owner2Id,
    name: 'Dairy & Perishable Cold Chain Hub',
    tagline: 'Temperature-controlled hub for dairy products and perishable goods',
    address: 'GIDC Phase 3, Near Kherva, Sanand',
    city: 'Sanand',
    district: 'Ahmedabad',
    state: 'Gujarat',
    latitude: 22.9533,
    longitude: 72.4121,
    storageType: 'Refrigerated Warehouse',
    totalCapacity: 8000000,
    availableCapacity: 4200000,
    temperatureMin: 2,
    temperatureMax: 6,
    humidityMin: 80,
    humidityMax: 90,
    acceptedCrops: ['Banana', 'Mango', 'Tomato', 'Potato', 'Carrot', 'Apple', 'Grapes', 'Chilli', 'Onion', 'Maize', 'Wheat', 'Soybean', 'Pulses', 'Brinjal', 'Cauliflower', 'Cabbage', 'Okra', 'Pumpkin'],
    minimumQuantity: 200,
    pricePerKg: 2.80,
    handlingCharge: 400,
    transportRatePerKm: 27,
    storageDuration: '1 to 30 days',
    paymentTerms: 'Daily settlement for dairy. Digital wallets and bank transfer.',
    damagePolicy: 'Dairy-specific insurance with 95% coverage against temperature variance. SMS alerts for every 15-minute interval.',
    powerBackup: true,
    cctvMonitoring: true,
    rating: 4.7,
    reviewsCount: 38,
    ...
    operatingHours: '24/7 - Dairy products require constant monitoring',
    contactPhone: '+91 98980 23456',
    contactEmail: 'dairy@greenfresh.in',
    features: ['IoT continuous monitoring', 'Temperature traceability', 'Quick release dock'],
  },
];
