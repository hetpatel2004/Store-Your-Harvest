              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="sm:col-span-2">
                  ...
                  <input
                    ...
                    placeholder="Tomato, Potato, Onion, Mango, Apple, Banana, Grapes, Chilli, Carrot, Maize, Wheat, Soybean, Pulses, Brinjal, Cauliflower, Cabbage, Okra, Pumpkin, Papaya, Watermelon, Muskmelon, Pomegranate, Guava, Orange, Lemon, BottleGourd, RidgeGourd, BitterGourd, SnakeGourd, GreenBeans, ClusterBeans, Peas, Spinach, Fenugreek, Mint, CurryLeaves, Drumsticks, Rice, Barley, Jowar, Bajra, Ragi"
                    className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 text-sm focus:ring-2 focus:ring-emerald-500 focus:outline-hidden"
                  />
                </div>
